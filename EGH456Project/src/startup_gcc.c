...
void (* const g_pfnVectors[])(void) =
{
    ...
    xTimer1AHandler,                      // Timer 1 subtimer A
    IntDefaultHandler,                      // Timer 1 subtimer B
    xTimer2AHandler,                      // Timer 2 subtimer A
    ...
    xADC1Sequence0,                      // ADC1 Sequence 0
